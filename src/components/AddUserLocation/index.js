...
class AddUser extends Component {
  static propTypes = {
    ...
    addUserLocationRequest: PropTypes.func.isRequired,
  };
  ...
  handleFormSubmit = (e) => {
    ...
    addUserLocationRequest(userInput, cordinates);
...
const mapStateToProps = state => ({
  modal: state.modal,
  loading: state.usersLocation.loading,
});

const mapDispatchToProps = dispatch => bindActionCreators({ ...ModalActions, ...UsersLocationActions }, dispatch);
